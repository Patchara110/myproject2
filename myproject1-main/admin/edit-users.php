...
<html lang="en">
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="form-group">
      ...
      name="fullname" required value="<?php echo $row-> FullName;?>">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      name="useremail" required value="<?php echo $row-> Email;?>">
      
    <div class="form-group">
      <label for="usermobile">Mobile:</label>
      <input type="text" maxlength="10" pattern="[0-9]{10}" 
      title="ตัวเลขสิบหลักเท่านั้น" class="form-control" id="usermobile" placeholder="Enter Mobile" 
      name="usermobile" required value="<?php echo $row-> Mobile;?>">
    </div>
    <div class="form-group">
      <label for="loginpassword">Password:</label>
      <input type="password" class="form-control" 
      id="loginpassword" placeholder="Enter password" 
      name="loginpassword" required value="<?php echo $row->  Password;?>">
    </div>
