...
COMMIT;
INSERT INTO `category` (`cat_name`) VALUES ('ชื่อประเภทสินค้า');
UPDATE `category` SET `cat_name` = 'ชื่อประเภทสินค้าใหม่' WHERE `cat_id` = 'รหัสประเภทสินค้า';
DELETE FROM `category` WHERE `cat_id` = 'รหัสประเภทสินค้า';

INSERT INTO `product` (`pro_name`, `cat_id`, `pro_price`, `pro_cost`, `pro_img`) 
VALUES ('ชื่อสินค้า', 'รหัสประเภทสินค้า', 'ราคาทุน', 'ราคาขาย', 'ลิ้งรูปภาพ');
UPDATE `product` SET `pro_name` = 'ชื่อสินค้าใหม่' WHERE `pro_id` = 'รหัสสินค้า';
DELETE FROM `product` WHERE `pro_id` = 'รหัสสินค้า';
